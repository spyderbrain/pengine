...
population(Country, Population) :-
    country(Country, _, _, _, _, Population, _, _).

capital(Country, Capital) :-
    country(Country, _, _, _, _, _, Capital, _).

currency(Country, Currency) :-
    country(Country, _, _, _, _, _, _, Currency).


% Facts about countries.
% ---------------------

% country(Country,  Region,  Latitude,  Longitude,  Area (sqmiles),  Population,  Capital,  Currency)
